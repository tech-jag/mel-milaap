          ...
          <div className="bg-gradient-to-r from-primary/5 to-secondary/5 border-b">
            <div className="container mx-auto px-4 lg:px-8 py-4 lg:py-6">
              ...
              <div className="flex flex-col gap-4 sm:gap-3">
                  ...
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-muted-foreground text-sm lg:text-base mt-1">
                        Discover your compatible matches
                      </p>
                    </div>
                  </div>
                ...
                {/* Bottom Row: Action Buttons - Mobile Full Width */}
          ...
          <section className="py-4 lg:py-8">
            <div className="container mx-auto px-4 max-w-7xl">
              <div className="w-full">
                ...
                <motion.div 
                  className="flex flex-col gap-4 mb-6 lg:mb-8 p-4 bg-card rounded-lg border"
                  variants={fadeInUp}
                  initial="initial"
                  whileInView="animate"
                  viewport={{ once: true }}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                  ...
                  <div className="lg:col-span-2">
                    ...
                    >
                      ...
                      <div className="flex justify-center gap-2 sm:gap-4 mt-4 lg:mt-6 px-4">
                        <Button 
                          size="lg" 
                          variant="outline" 
