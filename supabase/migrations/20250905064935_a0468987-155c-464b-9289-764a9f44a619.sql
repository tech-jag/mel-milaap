-- Create additional tables for security and features
...
-- Search embeddings for AI search (placeholder)
...
-- RLS Policies for search embeddings (read-only for users)
CREATE POLICY "Anyone can read search embeddings" ON public.search_embeddings
