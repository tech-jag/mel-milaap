...
-- Add missing member_profiles columns for enhanced matching
ALTER TABLE public.member_profiles 
ADD COLUMN IF NOT EXISTS immigration_status TEXT,
ADD COLUMN IF NOT EXISTS relocate_willing BOOLEAN DEFAULT false,
ADD COLUMN IF NOT EXISTS mother_tongue TEXT,
ADD COLUMN IF NOT EXISTS community_caste TEXT;
